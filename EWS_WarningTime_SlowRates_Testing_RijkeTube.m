...
% Save the figure
prediction_map_figure_name = sprintf("Prediction_Maps/RijkeTube/Prediction_Map_TT%d_SW%.2f_OR%.2f_SL%.5f_mu%.4f.fig", time_transient, smallest_window_size, overlap_ratio, significance_value_tau, mu);
